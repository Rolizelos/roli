...
client.channels.get(783589964842532895).send(`:inbox_tray: | <@${member.id}> adlı kişi sunucuya giriş yaptı. `)
if(member.user.bot === true) {
  client.channels.get(783589964842532895).send("Bu kişi bir bot olarak giriş yaptı.")
} 
} else {
	return;
}
